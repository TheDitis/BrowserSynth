...
import '../App/App.css';
import './Oscillator1.css';

export class Oscillator1 extends Component {
    constructor () {
        super();
        this.state = {
            oscObj: null,
    ...
    init_controls () {
        let freq = document.getElementById('osc1freq');
        let gain = document.getElementById("osc1gain");
    ...
    changeFreq = () => {
        let freq = document.getElementById('osc1freq').value;
    ...
    changeGain = () => {
        let gain = document.getElementById("osc1gain").value;
    ...
    render() {
        return (
            <div id={"osc1"} className={"oscillator"}>
                ...
                <input type={"range"} className={"oscgain"} id={"osc1gain"} min={"0"} max={"100"} onChange={this.changeGain}/><br/>
                <input type={"range"} className={"oscfreq"} id={"osc1freq"} min={"20"} max={"2000"} onChange={this.changeFreq}/>
            </div>
        )
    }
}
